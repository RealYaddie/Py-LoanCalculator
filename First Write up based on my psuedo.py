...
print(
f"""The total amount to be paid back is ${loan_repaid} .
The total amount to be paid back monthly is ${monthly_payment} .
The compound interest on the loan is ${compound_interest} .
""")
